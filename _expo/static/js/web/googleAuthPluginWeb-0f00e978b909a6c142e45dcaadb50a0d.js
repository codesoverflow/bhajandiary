__d((function(g,r,i,a,m,e,d){Object.defineProperty(e,"__esModule",{value:!0}),e.getFirebaseAuthWeb=u,e.signInWithGoogleWeb=async function(){try{const o=new n.GoogleAuthProvider,t=u(),s=(await(0,n.signInWithPopup)(t,o)).user;return console.log("User signed in:",s),s}catch(n){console.error("Error signing in with Google:",n)}return t.defaultAppAuthUser},e.signOutGoogleWeb=async function(){try{await u().signOut(),console.log("User signed out")}catch(n){throw console.error("Error signing out:",n),n}};var n=r(d[0]),o=r(d[1]),t=r(d[2]);let s=null;function u(){return s||(s=(0,n.getAuth)((0,o.getFirebaseAppWeb)())),s}}),1793,[3356,1804,740]);
__d((function(g,r,i,a,m,e,d){Object.defineProperty(e,"__esModule",{value:!0}),e.getFirebaseAppWeb=function(){l||(l=(0,t.initializeApp)(n.firebaseConfigWeb));return l};var n=r(d[0]),t=r(d[1]);let l=null}),1804,[730,3366]);
