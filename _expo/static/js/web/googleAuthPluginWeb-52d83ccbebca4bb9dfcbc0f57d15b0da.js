...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */var be;be='',W(new e.Component('platform-logger',(e=>new s(e)),"PRIVATE")),W(new e.Component('heartbeat',(e=>new le(e)),"PRIVATE")),ae(c,l,be),ae(c,l,'esm2017'),ae('fire-js','')}),2395,[2396,2399,2397,2400]);
...
/**
   ...
   * limitations under the License.
   */
(0,n.registerVersion)("firebase","11.8.1",'app')}),2403,[2395]);